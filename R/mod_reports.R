...
plot_export_controls_ui <- function(ns, prefix = "plt") {
  shiny::tagList(
    ...
    shiny::selectInput(ns(paste0(prefix, "_font_family")), "Font Family",
      choices = c("Arial", "Helvetica", "sans", "serif", "mono", "Times New Roman"), selected = "Arial"),
    shiny::numericInput(ns(paste0(prefix, "_base_size")), "Base Font Size", value = 6.5, min = 5, step = 0.5),
    shiny::numericInput(ns(paste0(prefix, "_axis_title_size")), "Axis Title Font Size", value = 6.5, min = 5, step = 0.5),
    shiny::numericInput(ns(paste0(prefix, "_axis_text_size")), "Axis Text Font Size", value = 6, min = 5, step = 0.5),
    shiny::numericInput(ns(paste0(prefix, "_legend_title_size")), "Legend Title Font Size", value = 6.2, min = 5, step = 0.5),
    shiny::numericInput(ns(paste0(prefix, "_legend_text_size")), "Legend Text Font Size", value = 5.8, min = 5, step = 0.5),
    shiny::numericInput(ns(paste0(prefix, "_plot_title_size")), "Plot Title Font Size", value = 7, min = 5, step = 0.5),
    shiny::numericInput(ns(paste0(prefix, "_caption_size")), "Caption Font Size", value = 5.8, min = 5, step = 0.5),
    ...
    shiny::numericInput(ns(paste0(prefix, "_label_size")), "Label Font Size", value = 2.1, min = 1, step = 0.1),
    ...
    shiny::selectInput(ns(paste0(prefix, "_theme_name")), "Base Theme",
      choices = c("theme_nature", "theme_classic", "theme_bw", "theme_minimal", "theme_void", "theme_pubr"),
      selected = "theme_nature"),
    shiny::textInput(ns(paste0(prefix, "_geno_color")), "Genotype Color", value = meridian_nature_color("signal_blue")),
    shiny::textInput(ns(paste0(prefix, "_env_color")), "Environment Color", value = meridian_nature_color("accent_orange")),
    shiny::textInput(ns(paste0(prefix, "_pos_fill")), "Positive Fill", value = meridian_nature_color("heat_high")),
    shiny::textInput(ns(paste0(prefix, "_neg_fill")), "Negative Fill", value = meridian_nature_color("heat_low")),
    shiny::sliderInput(ns(paste0(prefix, "_point_size")), "Point Size", min = 0.5, max = 8, value = 1.8, step = 0.1),
    ...
    shiny::checkboxInput(ns(paste0(prefix, "_show_grid_major")), "Show Major Grid", value = FALSE),
    ...
    shiny::numericInput(ns(paste0(prefix, "_dpi")), "DPI", value = 600, min = 72, step = 10),
    ...
    shiny::selectInput(ns(paste0(prefix, "_format")), "Format", choices = c("SVG", "PDF", "TIFF", "PNG"), selected = "SVG")
  )
}
  ...
  bslib::navset_card_tab(
    ...
    bslib::nav_panel(
      ...
      bslib::layout_column_wrap(
        ...
        shiny::numericInput(ns("comp_label_size"), "Label Font Size", value = 8, min = 5),
      ...
      bslib::layout_column_wrap(
        ...
        shiny::numericInput(ns("comp_title_size"), "Title Font Size", value = 8, min = 5),
        ...
        shiny::checkboxInput(ns("comp_shared_theme"), "Apply Shared Theme", value = TRUE),
        shiny::selectInput(ns("comp_shared_theme_name"), "Shared Theme",
          choices = c("theme_nature", "theme_classic", "theme_bw", "theme_minimal", "theme_void"), selected = "theme_nature"),
        shiny::selectInput(ns("comp_shared_font"), "Shared Font", choices = c("Arial", "Helvetica", "sans", "serif", "mono"), selected = "Arial"),
        shiny::numericInput(ns("comp_shared_base"), "Shared Base Size", value = 6.5, min = 5),
        shiny::selectInput(ns("comp_shared_legend"), "Shared Legend Position",
          choices = c("right", "bottom", "top", "left", "none"), selected = "right"),
        shiny::checkboxInput(ns("comp_shared_grid_major"), "Shared Major Grid", value = FALSE),
      ...
      bslib::layout_column_wrap(
        ...
        shiny::numericInput(ns("comp_dpi"), "DPI", value = 600, min = 72),
        shiny::selectInput(ns("comp_format"), "Format", choices = c("SVG", "PDF", "TIFF", "PNG"), selected = "SVG"),
